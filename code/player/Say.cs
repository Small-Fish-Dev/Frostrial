...
namespace Frostrial
{
	...
	public partial class Player
	{
		...
		public static readonly Dictionary<VoiceLine, Monologue> VoiceLines = new()
		{
			...
			//{ VoiceLine.CaughtSmallFish, new Monologue( "This isn't going to cut it", "caughtsmallfish" ) },
			//{ VoiceLine.CaughtFish, new Monologue( "There we go!", "caughtfish" ) },
			//{ VoiceLine.CaughtBigFish, new Monologue( "That's a big one!", "caughtbigfish" ) },
			//{ VoiceLine.LeFishe, new ( "I can always count on French Cuisine", "lefishe" ) },
			...
			//{ VoiceLine.Intro, new( "Today is the day I buy my way out of here.", "intro", false ) },
			{ VoiceLine.ImAlmostThere, new( "I'm almost there", "imalmostthere" ) },
			//{ VoiceLine.Outro, new( "Goodbye fishes.", "outro" ) },
			//{ VoiceLine.OldYetiHand, new( "This Yeti Hand is old, lucky", "oldyetihand", false ) },
			{ VoiceLine.NotDrillingHere, new( "I'm not drilling there.", "notdrillinghere" ) },
			//{ VoiceLine.FoundBait, new( "I found a worm, good for bait I guess.", "foundbait" ) },
			{ VoiceLine.NoItems, new( "I don't have any of those...", "noitems" ) },
			//{ VoiceLine.CantPlace, new( "I can't put that there...", "cantplace" ) },
			...
			//{ VoiceLine.YetiJumpscare, new( "********* ! ! !", "yetijumpscare", false ) }
		};
